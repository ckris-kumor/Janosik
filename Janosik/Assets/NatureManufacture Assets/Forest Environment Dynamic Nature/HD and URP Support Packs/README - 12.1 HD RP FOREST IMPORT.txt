About scene:
We set all plants and grass as tree objects as unity HD RP doesn't support terrain grass systems. At 12.1 hd rp 2021.2 seams it to works BUT it have light issues.
We wait for unity fix, as hd rp lit shader have same issues like ours, so source of the problem with light at unity instanced grass system  is on unity side.
We will update hd rp support pack/demo when unity will fix that grass in upcomming 2021.2 fixes.
...
- you need HD SRP pipline 12.1 if you use higher etc custom shaders could not work but seams they should. 
Thats why we provide 12.1 version which seams to work with much higher versions aswell. 
