...
public class DrawNavMeshPath : MonoBehaviour{
    ...
    public void Start(){
        carriageSphereCollider = gameObject.GetComponent<SphereCollider>();
    ...
    public void CarriageToPos(Vector3 ObjDestination){
        ...
        LeanTween.init(2000);
        gameObject.transform.LookAt(ObjDestination, Vector3.up);
        gameObject.transform.LeanMove(new Vector3(ObjDestination.x, 33.33126f, ObjDestination.z), 10.0f);
